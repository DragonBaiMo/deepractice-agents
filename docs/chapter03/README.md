...
| 3.2 | [提示工程基础](3.2-Prompt工程基础.md) | System Prompt设计、语义鸿沟与DPML预告 | 40分钟 |
...
| 概念 | 本章引入位置 | 深入章节 |
|-----|-------------|---------|
| 语义鸿沟 | 3.2节 Prompt本质 | 第五章 PromptX |
| DPML | 3.2节 结构化Prompt | 第五章 DPML语法 |
| Engram记忆网络 | 3.3节 RAG质疑 | 第五章 记忆系统 |
| 认知架构 | 3.4节 功能vs认知 | 第九章 Monogent |
